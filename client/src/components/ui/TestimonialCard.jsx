...
const TestimonialCard = ({
  ...
  return (
    ...
    >
      <GlassCard className="relative h-full overflow-hidden" hover={false}>
        <motion.div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-secondary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
